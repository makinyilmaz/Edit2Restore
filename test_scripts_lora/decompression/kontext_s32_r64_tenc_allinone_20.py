...
input_dir = "test_data/decompression_testsets/kodak_20"
output_dir = "results/kontextlora_s32_r64_tenc_allinone/decompression_20"
...
prompt = "Remove compression artifacts and restore the clean image"
