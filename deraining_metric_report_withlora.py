...
def main():
    # Paths
    pred_folder = "results/deraining/Rain100L/withlora"
    ...
    with open("results/deraining/evaluation_results_withlora.txt", "w") as f:
    ...
    print("\nResults saved to 'results/deraining/evaluation_results_withlora.txt'")
